...
#define HTTP_AUTHEN_ERROR_BASE	600
#define HTTP_AUTHEN_ERROR_SESSION_KEY_NOT_MATCH	601
#define HTTP_AUTHEN_ERROR_TIMEOUT		602
#define HTTP_AUTHEN_ERROR_SESSION_KEY_NOT_CORRECT	603
#define	HTTP_AUTHEN_ERROR_CAMERA_NOT_AVAILABLE	604
#define HTTP_AUTHEN_ERROR_IP_BLOCK	605


#define SECURITY_CONCERN
/*
...
typedef enum { A_UNKNOWN, A_SNAPSHOT, A_STREAM, A_COMMAND, A_FILE, A_APPLETVASTREAM, A_APPLETVSTREAM,A_APPLETASTREAM, A_LOG,A_MINI_STATUS,A_STATUS} answer_t;
